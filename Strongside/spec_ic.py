...
#output: A protein string of length n-1 whose prefix spectrum is equal to L 
...
def main():
	...
	with open(sys.argv[1]) as infile:
		spectrum = map(float, infile.readlines())

	print sum([weights['W']*4, weights['M']*3, weights['Q']*2, weights['S']])
